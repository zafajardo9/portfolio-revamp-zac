...
import { experienceQnA, workExperiences, interests } from "@/data/content";
      ...
      <div className="space-y-20">
          ...
          <Card className="border-none shadow-none bg-secondary/5">
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                ...
                web development and a keen interest in creating elegant
                solutions to complex problems. My journey in technology has been
                driven by curiosity and a desire to build meaningful
        ...
        <div className="grid md:grid-cols-[200px_1fr] gap-8 items-start">
          ...
          <div className="space-y-6">
            {experienceQnA.map((item, index) => (
              <Card
                key={index}
                className="border-none shadow-none bg-secondary/5"
              >
                <CardHeader>
